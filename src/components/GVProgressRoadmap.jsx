...
const SHEET_NAME = 'Gumohar_Villas'
...
export default function GVProgressRoadmap() {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-16">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white p-7 rounded-[2rem] shadow-xl shadow-indigo-100/40 border border-white min-w-[320px]">
          ...
          <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden">
            <motion.div initial={{ width: 0 }} animate={{ width: `${overall}%` }} transition={{ duration: 1.5 }} className="h-full bg-[#E509EF] rounded-full" />
          </div>
        </motion.div>
      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-1.5 w-full bg-slate-50 rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} animate={{ width: `${it.computed}%` }} className="h-full  rounded-full bg-[#E509EF]" />
                    </div>
                  </div>
