...
const projects = [
  {
    ...
    images: ['/images/ns-1.jpeg', '/ns-front-2.jpeg'],
  },
  {
    type: 'NS Homes 2.0',
    name: 'DTCP/RERA',
    description: 'NS Homes 2.0 is an extension of NS Homes, spreading across 4 acres of land. This project is now fully sold out',
    location: 'location : Meerkhanpet',
