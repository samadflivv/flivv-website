...
const RivendellAbout = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-white overflow-x-hidden flex items-center justify-left relative pb-20 pt-20 lg:px-[10%] px-1"
    >
      <div className="reveal-text relative w-full lg:max-w-8xl">
        <p
          ref={textRef}
          className="text-justify text-black-reveal text-2xl lg:text-4xl font-normal leading-normal"
        >
