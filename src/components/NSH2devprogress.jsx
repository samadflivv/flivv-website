...
export default function ProgressRoadmap() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-10 min-h-screen font-sans">
      {/* HEADER SECTION */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-16">
        <div>
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-2 mb-2">
            <div className="w-4 h-4 rounded-full bg-[#612437] animate-pulse"></div>
            <span className="text-[#612437] font-bold tracking-widest text-lg lg:text-xl uppercase animate-pulse">Real-Time Development Dashboard</span>
          </motion.div>
          <h1 className="text-5xl font-black text-slate-900 tracking-tight">NS <span className="text-[#612437]">Homes 2.0</span></h1>
        </div>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white p-7 rounded-[2rem] shadow-xl shadow-indigo-100/40 border border-white min-w-[320px]">
          ...
          <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden">
            <motion.div initial={{ width: 0 }} animate={{ width: `${overall}%` }} transition={{ duration: 1.5 }} className="h-full bg-[#602437] rounded-full" />
          </div>
        </motion.div>
      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-1.5 w-full bg-slate-50 rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} animate={{ width: `${it.computed}%` }} className="h-full  rounded-full bg-[#602437]" />
                    </div>
                  </div>
